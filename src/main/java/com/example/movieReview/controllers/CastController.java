...
public class CastController {
    ...
    public CastController(MovieRepository movieRepository, CastRepository castRepository,
            MovieMappingService movieMappingService) {
    ...
    @PostMapping("admin/cast/{movieId}")
    ...
    @DeleteMapping("admin/cast/{castId}")
 ...
 * "castUrl":
 * "https://static.toiimg.com/thumb/msid-100157858,width-1280,resizemode-4/100157858.jpg",
 * "roleName": "Karthik"
 * },
 * {
